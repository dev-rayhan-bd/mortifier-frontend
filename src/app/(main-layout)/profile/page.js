    ...
    <section className=" py-10 md:py-20">
      ...
      <div className="xxl:w-[1340px] mx-auto flex">
        <div className="details-info flex flex-col lg:flex-row gap-5 p-5 min-h-[660px] w-full rounded-lg shadow-lg">
          ...
          <div className="right-information w-full lg:w-[75%] pt-5">
              ...
              <div className="following-follower grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div className="item text-center px-14 py-1 md:py-4 bg-[#e2697121] border border-primary rounded-xl shadow-lg">
                  <div className="total text-xl md:text-3xl font-bold text-primary">
                    {membership?.data?.[0]?.totalMembership}
                  </div>
            ...
            <p className=" text-xl mx-4 py-6">
              Share thoughts of your journey to become MorFitter. Inspire and
              encourage others with the positive steps you have taken
            </p>
            ...
            <div className=" mt-5">
              ...
              <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-4">
                ...
                {following?.data?.map((item) => (
                  <div
                    key={item?._id}
                    className=" flex items-center gap-3 shadow-lg px-3 py-2 rounded-lg"
                  >
                    <Image
                    ...
                    <div>
                      <h2 className=" text-xl font-semibold capitalize">
                        {item?.followingDetails?.firstName}{" "}
                        {item?.followingDetails?.lastName}
                      </h2>
              ...
              <div className="qualification flex justify-between items-center w-full mb-4 shadow-lg py-4 px-3 rounded-lg">
                ...
                <Badge count={invitation?.data?.length}>
                  <button
                    ...
                    className="add-btn text-white bg-[#0ba5931a] border border-greenColor px-2 md:px-4 py-1 md:py-[14px] rounded-lg "
                  >
                    <FaPlus className=" text-greenColor" />
                  </button>
                </Badge>
        ...
        <InvitationModal
          ...
          handleInvitationCancel={handleInvitationCancel}
          handleInvitationOk={handleInvitationOk}
      ...
      <div
        onClick={showDrawer}
        className="  fixed  top-auto bottom-4 md:bottom-10 right-3 md:right-12 p-3 flex items-center justify-center cursor-pointer"
      >
